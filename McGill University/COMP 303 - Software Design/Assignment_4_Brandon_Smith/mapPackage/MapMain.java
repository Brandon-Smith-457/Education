...
/**
 * <h1>Map Application</h1>This class creates an object of type Map and implements all of the I/O required to fully interact with the map.
 * 
...
public class MapMain {
	/**
	 * This main method calls all necessary functions from Map in order to validate and update an instance of type Map.  It also imposes limits on the possible
	 * user inputs.
	 * @param args Unused
	 */
